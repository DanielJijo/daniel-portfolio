...
function DockItem({
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className={`relative inline-flex items-center justify-center rounded-full border-neutral-700 border-2 shadow-md bg-white/80 text-black dark:bg-zinc-900/80 dark:text-white ${className}`}
      tabIndex={0}
      role="button"
      aria-haspopup="true"
    >
